...
| R-013 | Trazas filtran prompts, documentos, mensajes o salidas completas del modelo. | Medium | Critical | Mitigating | Subfase 0.7 usa hashes, referencias, objetos cerrados y trace visibility; controles finales quedan para Subfase 0.10. | Codex / JusNova Chief Backend Architect |
